...
export class TransactionService {
    ...
    private convertItemFromServer(transaction: Transaction): Transaction {
        ...
        copy.transactionTime = this.dateUtils
            .convertDateTimeFromServer(transaction.transactionTime);
        copy.transactionDate = this.dateUtils
            .convertLocalDateFromServer(transaction.transactionDate);
        return copy;
    }
    ...
    private convert(transaction: Transaction): Transaction {
        ...
        copy.transactionTime = this.dateUtils.toDate(transaction.transactionTime);
        copy.transactionDate = this.dateUtils
