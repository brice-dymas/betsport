package com.gcs.betsport.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.gcs.betsport.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.gcs.betsport.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
